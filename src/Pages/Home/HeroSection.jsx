...
export default function HeroSection() {
  ...
  const titles = ["Front End", "Game"]; // Texts to rotate
  let titleIndex = 0;
        ...
        <div className="hero--section--content--box">
          <div className="hero--section--content">
            <h1 className="hero--section--title">
              <p id="title--initial" className="section--title">
                Hola!! 👋🏻 soy
              </p>
              <p className="hero--section--name">Matías Ferrari</p>
            </h1>
            <h1 id="gradient" className="hero--section--title">
              <span className="hero--section-title--color">{title}</span> <br />
              Developer
            </h1>
            <p className="hero--section-description">
              Apasionado desarrollador en constante búsqueda de desafíos, crecimiento y nuevas oportunidades emocionantes.
            </p>
          </div>
          <a
            id="ButtonCV"
